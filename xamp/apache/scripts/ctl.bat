...
cmd.exe /C start /B /MIN "" "C:\Users\Vinu\Desktop\Github\newgt\xamp\apache\bin\httpd.exe"
...
if not exist "C:\Users\Vinu\Desktop\Github\newgt\xamp\apache\logs\httpd.pid" GOTO finish
del "C:\Users\Vinu\Desktop\Github\newgt\xamp\apache\logs\httpd.pid"
goto finish
